...
class a_dbbak extends syController
{
	...
	function bak(){
		...
		ob_implicit_flush(1);
		ob_end_flush();
		echo '<meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><link href="doyo/admin/template/style/admin.css" rel="stylesheet" type="text/css" />';
	...
	private function write_file($txt,$filename){
		$re=true;
