...
if($GLOBALS['G_DY']['rewrite']["rewrite_open"]==1){
	$GLOBALS['G_DY']['url']["url_path_base"] = $GLOBALS['G_DY']['rewrite']["rewrite_dir"].'index.php';
}else{
...
$GLOBALS['TURL']=$GLOBALS['WWW'].'template/'.$doyoConfig['ext']['view_themes'].'/';//系统模板目录
